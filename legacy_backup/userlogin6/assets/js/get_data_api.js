...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (uploadFormEl) uploadFormEl.addEventListener("submit", async (event) => {
        ...
        try {
            const result = await safeFetch('upload.php', { method: 'POST', body: formData });
...
document.getElementById('download-excel-ex').addEventListener('click', function () {
    window.location.href = '/incentiveapp_integration/userlogin1/superadmin/crm/example_format.xlsx';
});
