...
$excelPath = __DIR__ . "/lead984940883e9487t5rufdjbhiv9c0u348yfoilsj2.xlsx";

// Excel URL (ONLY FOR READING IF PUBLIC)
$excelUrl  = "https://www.searchhomesindia.in/superadmin_new/myapicontainer/v2/api/lead984940883e9487t5rufdjbhiv9c0u348yfoilsj2.xlsx";

// Manual round-robin users
$roundRobinUsers = [
    ["code" => "Tharun2003", "phone" => "9900950472"],
    ["code" => "ananda1112", "phone" => "7204742415"],
    ["code" => "gangaraja1114", "phone" => "6364435987"],
    ["code" => "Shakir2060", "phone" => "8792805715"],
    ["code" => "prajwal2026", "phone" => "9008605797"],
    ["code" => "rishanth2042", "phone" => "6366037401"],
    ["code" => "monika3000", "phone" => "9036273181"],
    ["code" => "Shylendra2075", "phone" => "8147392874"],
    ["code" => "Shahid1204", "phone" => "8951875637"],
    ["code" => "Anurag2076", "phone" => "7259310238"],
    ["code" => "Asifa2056", "phone" => "8951677276"],
    ["code" => "Tameem2101", "phone" => "8105032626"]
];

// Track last assigned user in local file
$roundRobinFile = __DIR__ . "/last_user2.txt";
