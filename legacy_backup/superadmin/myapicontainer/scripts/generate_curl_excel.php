...
if (in_array($lead_source, $portalSources)) {
    $apiEndpoint = "https://www.searchhomesindia.in/superadmin/myapicontainer/v2/api/portal_leads";
    $payload = json_encode([
        "name" => "Test Name",
    ...
    $apiEndpoint = "https://www.searchhomesindia.in/superadmin/myapicontainer/v2/api/googleads_leads";
    $payload = json_encode([
        "name" => "Test Name",
        "email" => "test@example.com",
        "number" => "1234567890",
